...
void main() {
  ...
  late GetAllFoodItemsUsecase usecase;

  setUp(() {
    mockRepository = MockFoodItemsRepository();
    usecase = GetAllFoodItemsUsecase(repository: mockRepository);
  });
  ...
  final tFoodItems = [
    ...
    const FoodItemEntity(
      ...
      isAvailable: true,
      addedBy: 'Restaurant B',
      isBestSeller: true,
      isDiscounted: true,
    ),
  ];

  group('GetAllFoodItemsUsecase', () {
    test('should return list of food items when repository call is successful',
        () async {
      // Arrange
      ...
      verify(() => mockRepository.getAllFoodItems()).called(1);
